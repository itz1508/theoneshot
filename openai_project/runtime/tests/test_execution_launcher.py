...
def test_case_21_export_uses_evidence_name(tmp_path):
    """The launcher's output directory is an evidence export with unambiguous file names."""
    request,*_=prepared(tmp_path); result=launch_execution(request); export=tmp_path/"export"
    assert result["execution_status"]=="executed"
    # The exported lock uses the unambiguous evidence name
