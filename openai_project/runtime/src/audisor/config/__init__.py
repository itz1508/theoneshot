"""Audisor configuration system.

Provides legacy user-level CLI configuration (A-Flow toggle, provider
settings) and the new host-agnostic configuration layer with profiles,
precedence rules, and safety limit merging.
"""
